...
+ (instancetype)loadingProgressWithCompletionHandler:(void(^)( NSString * __nullable state,  NSError * __nullable error, __nullable AAPLLoadingUpdateBlock update))handler;
