...
@interface UICollectionView (iOS9Additions)
// Only available on iOS 9. use -aapl_supplementaryViewOfKind:(NSString *)kind atIndexPath:(NSIndexPath *)indexPath instead
